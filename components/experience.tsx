    ...
    <section id="experience" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Experience & Achievements</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            My professional journey and key accomplishments in the world of software development.
          </p>
        </div>
            ...
            >
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    <CardTitle className="text-xl text-slate-900 mb-2">{exp.title}</CardTitle>
                  ...
                  <Badge variant="outline" className="border-slate-300 text-slate-700 w-fit">
                    {exp.period.split(" - ")[1] === "Present" ? "Current" : "Previous"}
                  </Badge>
                </div>
              </CardHeader>
